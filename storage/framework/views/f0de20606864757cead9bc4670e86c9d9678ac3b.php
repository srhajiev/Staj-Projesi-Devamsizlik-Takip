        ...
        <div class="mt-2">
            <form action="" method="POST" class="remove-record text-center">
                ...
                <div class="md:flex md:items-center mb-6">
                    <h3 class="text-xl text-white font-bold">  <?php echo e($name ?? ''); ?> Silmek istediğine emin misin ?</h3>
                </div>
...
</div><?php /**PATH C:\Users\arifh\Desktop\stajjjjjjj\laravel-school-management-system\resources\views/backend/modals/delete.blade.php ENDPATH**/ ?>