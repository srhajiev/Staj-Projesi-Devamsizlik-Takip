...
<?php $__env->startSection('content'); ?>
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            <div>
              <h2 class="text-gray-700 uppercase font-bold">Sınıflar</h2>
</div>
<div class="flex flex-wrap items-center">
    <a href="<?php echo e(route('classes.create')); ?>" class="bg-gray-200 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
        ...
        <span class="ml-2 text-xs font-semibold">Sınıf</span>
    </a>
</div>
</div>
<div class="mt-8 bg-white rounded border-b-4 border-gray-300">
    <div class="flex flex-wrap items-center uppercase text-sm font-semibold bg-gray-300 text-gray-600 rounded-tl rounded-tr">
        ...
        <div class="w-2/12 px-4 py-3">Sınıf Adı</div>
        <div class="w-1/12 px-4 py-3">Öğrenciler</div>
        <div class="w-4/12 px-4 py-3 text-center">Ders Kodu</div>
        <div class="w-2/12 px-4 py-3">Öğretmen</div>
        <div class="w-2/12 px-4 py-3 text-right">İşlem</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\arifh\Desktop\stajjjjjjj\laravel-school-management-system\resources\views/backend/classes/index.blade.php ENDPATH**/ ?>