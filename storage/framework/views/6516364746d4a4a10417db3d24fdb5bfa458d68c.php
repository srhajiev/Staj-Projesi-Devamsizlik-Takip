<div class="bg-blue-700 px-4 sm:px-6 py-3 flex items-center justify-between shadow h-16 fixed top-0 left-0 right-0 z-50">
    ...
    margin: 1vw;" class="responsive" src="/logo.png">
        <span class="font-semibold text-sm sm:text-xl tracking-tight">STAJ PROJESI</span>
    </div>
    <div class="relative">
...
</div><?php /**PATH C:\Users\arifh\Desktop\stajjjjjjj\laravel-school-management-system\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>