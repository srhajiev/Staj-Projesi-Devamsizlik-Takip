...
<?php $__env->startSection('content'); ?>
    ...
    <div>
        <h2 class="text-gray-700 uppercase font-bold">Katılım - <?php echo e($class->class_name); ?></h2>
    </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <h3 class="text-gray-700 uppercase font-bold"> Tarih: <?php echo e(date('Y-m-d')); ?></h3>
    </div>

    <div class="w-full px-6 py-6">
        <div class="flex items-center bg-gray-200 rounded-tl rounded-tr">
            <div class="w-4/12 text-left text-gray-600 py-2 px-4 font-semibold">Adı</div>
            <div class="w-3/12 text-left text-gray-600 py-2 px-4 font-semibold">Numara</div>
            <div class="w-5/12 text-right text-gray-600 py-2 px-4 font-semibold">Katılım Durumu</div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\arifh\Desktop\stajjjjjjj\laravel-school-management-system\resources\views/backend/attendance/create.blade.php ENDPATH**/ ?>